...
export default function Login() {
        ...
        return (
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form>
                        <Form.Group className="mb-3" controlId="formBasicEmail" className="input-with-gray light">
                            <Form.Label>User Name</Form.Label>
                            <Form.Control type="email" placeholder="User Name" />
                        </Form.Group>

                        <Form.Group className="mb-3" controlId="formBasicPassword" className="input-with-gray light">
